...
1. __Extensibility__: A modular architecture that can scale to accomodate new time-series anlaysis methods without requiring modifications to the core `pyhctsa` codebase.
